"""Module for preprocessing Brazilian Portuguese texts."""
...
# def get_keywords(pos_tagger: POSTagger, text: str) -> List:
#     """Return keywords from `text`.

#     Args:
#         pos_tagger (POSTagger): part-of-speech tagger object.
#         text (str): text to be processed.
